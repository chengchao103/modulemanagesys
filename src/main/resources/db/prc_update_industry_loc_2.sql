DELIMITER $$
DROP PROCEDURE IF EXISTS prc_update_industry_loc_2 $$
CREATE PROCEDURE prc_update_industry_loc_2()
  BEGIN
    /*
    根据行业统计设备分布
    ...
    */
    ...
    REPEAT
      FETCH industry_loc
      INTO p_industry, p_province, p_module_count;
      BEGIN
        SELECT count(*)
        INTO p_num
        FROM ts_sys_statistics_analysis
        WHERE industry = p_industry AND province = p_province AND city = -1 AND
